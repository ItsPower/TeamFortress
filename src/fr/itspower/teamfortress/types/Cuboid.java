...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable{
    ...
    public CuboidIterator iteratorr() {
    ...
    public boolean hasPlayerInside(Player player){
        ...
        if(xmin <= loc.getX() && xmax >= loc.getX() && ymin <= loc.getY() && ymax >= loc.getY() && zmin <= loc.getZ() && zmax >= loc.getZ() && w.getName().equals(loc.getWorld().getName())){
        	return true;
        }
        else{
        	return false;
